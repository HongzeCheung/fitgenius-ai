...
### 4. AI 对话私教 (AI Chat Coach)
*   **上下文联动**：自动结合个人资料、近期训练日志与当前计划，生成更精确的训练/恢复/饮食建议。
*   **结构化建议**：输出包含“核心回答 + 可执行步骤 + 注意事项”的三段式建议，便于直接落地执行。
*   **风险提示**：在可能存在伤痛或过载风险时，明确提示并建议线下评估。

### 5. 动作库与生物力学 (Exercise Encyclopedia)
...
3.  **AI 对话**：在“私教”标签页切换到“AI 对话”，直接提问并获得结合个人数据的具体指导。
